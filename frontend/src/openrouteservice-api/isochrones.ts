import type { Position, FeatureCollection, Polygon } from "geojson";
import type { Metadata, Profile } from "./common.js";
import type { DirectionsOptions, DirectionsUnits } from "./directions.js";
